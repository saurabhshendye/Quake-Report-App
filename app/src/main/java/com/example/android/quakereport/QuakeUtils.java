...
/**
 * Created by Saurabh on 10/18/2017.
 */
    ...
    public static ArrayList<EarthQuake> extractEarthquakes(){
        ...
        try {
            ...
            for (int i= 0; i < count; i++) {
                ...
                Time = featureObject.getJSONObject("properties").getString("time");
                Magnitude = featureObject.getJSONObject("properties").getString("mag");
